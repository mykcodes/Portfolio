      ...
      child: GestureDetector(
        ...
        child: AnimatedBuilder(
          ...
          child: BackdropFilter(
            ...
            child: Stack(
              children: [
                // Blueprint Overlay Background (Visible only on hover)
                Positioned.fill(
                ...
                // Animated corner brackets (targeting/scanning feel)
                if (_isHovered)
                  Positioned.fill(
                    child: AnimatedBuilder(
                      animation: _borderGlowController,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Expanding Classified Document Panel
                      AnimatedSize(
                        duration: MotionSystem.standard,
                        curve: MotionSystem.deceleration,
...
class _EnhancedBlueprintPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (sweepProgress > 0 && sweepProgress < 1.0) {
      ...
      canvas.drawRect(Rect.fromLTWH(sweepX - 40, 0, 80, size.height), scanPaint);
    }
  }

  @override
  bool shouldRepaint(covariant _EnhancedBlueprintPainter old) => old.sweepProgress != sweepProgress;
}

// =========================================================================
// Corner Bracket Painter — L-shaped targeting brackets that slide in
// =========================================================================
class _CornerBracketPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double inset = 12.0 + (8.0 * (1.0 - progress)); // Slides inward

    // Top-left bracket
    canvas.drawLine(Offset(inset, inset), Offset(inset + bracketLen, inset), paint);
    canvas.drawLine(Offset(inset, inset), Offset(inset, inset + bracketLen), paint);

    // Top-right bracket
    canvas.drawLine(Offset(size.width - inset, inset), Offset(size.width - inset - bracketLen, inset), paint);
    canvas.drawLine(Offset(size.width - inset, inset), Offset(size.width - inset, inset + bracketLen), paint);

    // Bottom-left bracket
    canvas.drawLine(Offset(inset, size.height - inset), Offset(inset + bracketLen, size.height - inset), paint);
    canvas.drawLine(Offset(inset, size.height - inset), Offset(inset, size.height - inset - bracketLen), paint);

    // Bottom-right bracket
    canvas.drawLine(Offset(size.width - inset, size.height - inset), Offset(size.width - inset - bracketLen, size.height - inset), paint);
    canvas.drawLine(Offset(size.width - inset, size.height - inset), Offset(size.width - inset, size.height - inset - bracketLen), paint);
  }
